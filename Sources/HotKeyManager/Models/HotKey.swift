...
public struct Modifier: Identifiable, Codable, Equatable, Hashable, Comparable, Sendable {
    ...
    public enum Side: String, Codable, CaseIterable, Comparable, Sendable {
        ...
        public var displayName: String {
            switch self {
            case .either: return String(localized: "Either", bundle: .module)
            case .left: return String(localized: "Left", bundle: .module)
            case .right: return String(localized: "Right", bundle: .module)
            }
        }
...
public struct HotKey: Codable, Equatable, Sendable {
    ...
    public init(key: Key?, modifiers: Modifiers, isDoubleTap: Bool = false) {
        self.key = key
        self.modifiers = modifiers
